...
bool FuzzLockTest(const uint8_t *rawData, size_t size)
{
    uint32_t code = static_cast<uint32_t>(ScreenLockServerIpcInterfaceCode::LOCK);
    MessageParcel data;
