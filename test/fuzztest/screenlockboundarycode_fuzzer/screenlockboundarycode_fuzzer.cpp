...
#include "screenlockboundarycode_fuzzer.h"
...
bool FuzzScreenlockBoundaryCodeTest(const uint8_t *rawData, size_t size)
{
    uint32_t code = static_cast<uint32_t>(ScreenLockServerIpcInterfaceCode::UNLOCK) + 1;
    MessageParcel data;
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::FuzzScreenlockBoundaryCodeTest(data, size);
